...
VALUES
    ...
    ('졸업요건 관리를 위한 필수확인 사항 안내(2024재공지)', '최근 졸업요건 관리 미흡으로 졸업이 지연되는 사례가 종종 발생하고 있습니다. 이에 학생 본인의 졸업요건 관리를 위한 필수확인 사항을 안내하오니, 개인별 철저한 학점 관리를 통해 본인이 졸업을 희망하는 시기에 졸업하지 못하는 일이 발생하지 않도록 각별히 유의하시기 바랍니다.', '2024-07-25', 'A24001001'),
