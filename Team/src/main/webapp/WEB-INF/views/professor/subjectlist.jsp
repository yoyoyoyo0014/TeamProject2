		...
		<div class="main_layout">
			...
			<div class="main_container">
				<div class="container-fluid">
					...
					<%-- 검색창 --%>
					<form action="<c:url value="/professor/subjectlist"/>">
					...
					<form class="input-group mb-3" action="">
						...
						<input type="text" class="form-control" name="search" placeholder="검색어를 입력하세요." style="z-index:0;">
						<div class="input-group-append">
					...
					<div class="ft_info_wrap d-flex justify-content-between">
						...
						<div class="ft_info_right_wrap">
							<a href="<c:url value="/professor/lectureinsert" />" class="btn btn-outline-primary">강의 개설</a>
						</div>
					</div>
				</div>
			</div>
